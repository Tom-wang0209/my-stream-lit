...
# 重新定义列配比，让四个组件紧密组合在页面左侧，右侧利用 col_spacer 吸收全部多余空间
col_tb_model, col_tb_guide, col_tb_theme, col_tb_auth, col_spacer = st.columns([2.5, 1.2, 1.4, 1.1, 5.8])
...
with col_tb_guide:
    # 4px 的 margin-top 完美补偿按钮与 selectbox 之间的结构高度落差
...
if not st.session_state.logged_in:
    ...
    <div style="text-align: center; padding: 120px 20px;">
        ...
        <p style="color: #8b949e; font-size: 0.9rem; margin-top: 5px;">Please unlock the terminal session template via upper left gate node.</p>
    </div>
